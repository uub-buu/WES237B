...
// kernel slot is where the element in x will be relative to its sliding window
...
// now we find the row and column of this input element by combining the start and offset values
